...
public class FirstServlet extends HttpServlet
{
    public void service(HttpServletRequest req, HttpServletResponse res) throws ServletException,  IOException 
	{
		...
		session.setAttribute("age", age);
           System.out.println("FirstServlet:first form data is kept in ses attributes & dyanmic form will be generated");
		...
		pw.print("&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp");
		...
		pw.println("<br>Session id is"+session.getId());
	} // service()
} // class